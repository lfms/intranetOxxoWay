...
Calendar.prototype.show = function() {	
	...
	//ggWinContent += ("<TABLE WIDTH='100%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#397FB3' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#012072' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
	ggWinContent += ("[<A style='color: white;' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Año Anterior'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" +
		",false);" +
		"\">&lt;&lt;A&ntilde;o<\/A>]</TD><TD ALIGN=center>");
	ggWinContent += ("[<A style='color: white;' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Mes Anterior'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
	...
	ggWinContent += ("[<A style='color: white;' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Avanzar Mes'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
		...
		"\">Mes><\/A>]</TD><TD ALIGN=center>");
	ggWinContent += ("[<A style='color: white;' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Avanzar Año'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		",false);" +
		"\">A&ntilde;o>><\/A>]</TD></TR></TABLE><BR>");
...
Calendar.prototype.showY = function() {
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=1 CELLSPACING=2 CELLPADDING=2 BGCOLOR='#012072' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
	ggWinContent += ("[<A style='color: white;' HREF=\"javascript:void(0);\" " +
		"onMouseOver=\"window.status='Año Anterior'; return true;\" " +
		"onMouseOut=\"window.status=''; return true;\" " +
		"onClick=\"Build(" + 
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=2 CELLPADDING=5 style='font-size:" + fontsize + "pt;'><TR>");
	var j;
	for (i=0; i<12; i++) {
...
Calendar.prototype.cal_data = function() {
	...
	// 2004 04 07 Opcional para el evento click de un día (después de asignar y conocer la fecha seleccionada)
	var auxDayClick = "";
	if( typeof rhCalendarDayClick == 'string' )
		auxDayClick = rhCalendarDayClick;
	...
	for (j=vFirstDay; j<7; j++) {
		vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j) + "><FONT FACE='" + fontface + "'>" + 
			"<A HREF='javascript:void(0);' " + 
				...
				"';ggPosX=-1;ggPosY=-1;nd();nd();" + auxDayClick + "\">" + 
		...
		for (j=0; j<7; j++) {
			vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j) + "><FONT FACE='" + fontface + "'>" + 
				"<A HREF='javascript:void(0);' " +
					...
					"onClick=\"document." + this.gReturnItem + ".value='" + 
					this.format_data(vDay) + 
					"';window.scroll(0,ggPosY);ggPosX=-1;ggPosY=-1;nd();nd();" + auxDayClick + "\">" + 
				this.format_day(vDay) + 
				"</A>" + 
				"</FONT></TD>";
			vDay=vDay + 1;
...
function Build(p_item, p_month, p_year, p_format) {
	...
	if( arguments.length >= 5 )
		recalPos = arguments[4];
	
	// Customize your Calendar here..
	gCal.gBGColor="#ffffff";
	gCal.gLinkColor="black";
	gCal.gTextColor="black";
	gCal.gHeaderColor="#012072";
...
//	if (ggPosX == -1 && ggPosY == -1) {
	...
	//Para que no se mueva al cambiar de mes o de anio
	if( recalPos )
	{
...
//Para que sea fija, comentas las líneas anteriores y estableces las constantes aquí:
//	ggPosX = 400;
//	ggPosY = 300;
...
var CLOSESTYLE=72;
var CLOSEWEIGHT=73;
if(typeof ol_fgcolor=='undefined'){var ol_fgcolor="#3f88d9";}
if(typeof ol_bgcolor=='undefined'){var ol_bgcolor="#012072";}
...
var oaboveheight=0;
var ocapicon="";
var otextfont="Tahoma,Arial,Helvetica";
var ocaptionfont="Tahoma,Arial,Helvetica";
var oclosefont="Tahoma,Arial,Helvetica";
var otextsize="1";
var ocaptionsize="1";
var oclosesize="1";
var oframe=self;
